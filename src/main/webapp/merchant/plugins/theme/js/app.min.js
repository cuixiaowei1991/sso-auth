...
function _init() {
    ...
    $.AdminLTE.layout = {
        activate: function () {
            ...
            if ($("body").hasClass("fixed"))$(".content-wrapper, .right-side").css("height", b - $(".main-footer").outerHeight()); else {
                var d;
                b >= c ? ($(".content-wrapper, .right-side").css("min-height", b - a), d = b - a) : ($(".content-wrapper, .right-side").css("height", c), d = c);
                var e = $($.AdminLTE.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("height", e.height())
            }
        }, fixSidebar: function () {
        ...
        activate: function () {
            ...
            $(".content-wrapper, .right-side").css("height", a.height())
        }
    }, $.AdminLTE.boxWidget = {
